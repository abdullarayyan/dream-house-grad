...
@section('title', 'الاسعار')

@section('page_title', 'الاسعار')
...
{{--    </div>--}}
    ...
    <div class="card-section">
        ...
        <form class="custom-form" method="POST" action="{{ url('/change') }}">
            ...
            <h5 class="section-title">المعلومات الرئيسية</h5>
            @if ( getSettingsObject('STONE_BUILDING'))
                <div class="form-group">
                    <label for="id_number">{{ getSettingsObject('STONE_BUILDING')->display_value }}</label>

                    <input id="id_number" type="{{ getSettingsObject('STONE_BUILDING')->type }}"
                           class="form-control @error('id_number') is-invalid @enderror"
                           name="STONE_BUILDING" value="{{ getSettingsObject('STONE_BUILDING')->value }}"
            ...
            @if (getSettingsObject('BASIC_BUILDING'))
                <div class="form-group">
                    <label for="basic_building">{{ getSettingsObject('BASIC_BUILDING')->display_value }}</label>
                    ...
                    <input id="basic_building" type="{{ getSettingsObject('BASIC_BUILDING')->type }}"
                           ...
                           name="basic_building" value="{{ getSettingsObject('BASIC_BUILDING')->value }}"
            ...
            @if (getSettingsObject('ELECTRICITY'))
                <div class="form-group">
                    <label for="electricity">{{ getSettingsObject('ELECTRICITY')->display_value }}</label>
            ...
            @if (getSettingsObject('WATER'))
                <div class="form-group">
                    ...
                    <input id="water" type="{{ getSettingsObject('WATER')->type }}"
                           ...
                           name="water" value="{{ getSettingsObject('WATER')->value }}" autocomplete="water">
            ...
            @if (getSettingsObject('NORMAL_PAIN'))
                <div class="form-group">
                    <label for="normal_pain">{{ getSettingsObject('NORMAL_PAIN')->display_value }}</label>

                    <input id="normal_pain" type="{{ getSettingsObject('NORMAL_PAIN')->type }}"
                           class="form-control @error('normal_pain') is-invalid @enderror"
                           name="normal_pain" value="{{ old('NORMAL_PAIN', getSettingsObject('NORMAL_PAIN')->value) }}"
            ...
            @if (getSettingsObject('FLAGSTONE_ES'))
                <div class="form-group">
                    <label for="flagstone_es">{{ getSettingsObject('FLAGSTONE_ES')->display_value }}</label>
            ...
            @if (getSettingsObject('FLAGSTONE_EG'))
                <div class="form-group">
                    <label for="flagstone_eg">{{ getSettingsObject('FLAGSTONE_EG')->display_value }}</label>

                    <input id="flagstone_eg" type="{{ getSettingsObject('FLAGSTONE_EG')->type }}"
                           class="form-control @error('flagstone_eg') is-invalid @enderror" name="flagstone_eg"
                           value="{{ getSettingsObject('FLAGSTONE_EG')->values }}" autocomplete="flagstone_eg">
            ...
            @if (getSettingsObject('FLAGSTONE_ET'))
                <div class="form-group">
                    <label for="flagstone_et">{{ getSettingsObject('FLAGSTONE_ET')->display_value }}</label>
...
{{--            @endif--}}
            ...
            @if (getSettingsObject('FLAGSTONE_IN'))
                <div class="form-group">
                    <label for="flagstone_in">{{ getSettingsObject('FLAGSTONE_IN')->display_value }}</label>
                    <input id="flagstone_in" type="{{ getSettingsObject('FLAGSTONE_IN')->type }}" name="flagstone_in"
            ...
            @if (getSettingsObject('DOOR_NORMAL'))
                <div class="form-group">
                    <label for="door_normal">{{ getSettingsObject('DOOR_NORMAL')->display_value }}</label>

                    <input id="door_normal" type="{{ getSettingsObject('DOOR_NORMAL')->number }}"
                           class="form-control @error('door_normal') is-invalid @enderror" name="door_normal"
                           value="{{ getSettingsObject('DOOR_NORMAL')->value }}" autocomplete="door_normal">
            ...
            @if (getSettingsObject('WINDOW_PP'))
                <div class="form-group">
                    ...
                    <input id="window_pp" type="{{ getSettingsObject('WINDOW_PP')->type }}"
                           class="form-control @error('window_pp') is-invalid @enderror" name="window_pp"
